      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white uppercase tracking-tight mb-4">
            <span className="text-yellow-500">In Person</span> Safety Training
          </h1>
          <p className="text-base text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Practical, hands-on training for crews who need direct field instruction and compliance confidence.
          </p>
        </div>
